...
# "/share/ScratchGeneral/tomkav/rerun_2017/uniform_trim/${1}"
# "/share/ScratchGeneral/tomkav/rerun_2017/uniform_trim_capseq/${1}"
echo "inDir= $inDir"
...
# /project/RDS-SMS-brainomics-RW/annotations/hg38
## Annotations
...
# Don't need this. SGE automatically deletes $TMPDIR on job termination 

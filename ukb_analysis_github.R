...
boruta_ukb_under65_model=Boruta(x=data_ukb_under65 , y=labels_ukb_under65, doTrace = 2 , maxRuns = 1000,num.threads=10)
...
boruta_ukb_over65_model=Boruta(x=data_ukb_over65 , y=labels_ukb_over65, doTrace = 2 , maxRuns = 1000,num.threads=35)
